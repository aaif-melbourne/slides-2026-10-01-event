# Slidev Skills for Agents

Agent skills that help agents understand and work with [Slidev](https://sli.dev) presentations.
...
This will add the Slidev skill to your agent configuration.

## What's Included

The Slidev skill provides your agent with knowledge about:
...
Once installed, your agent will automatically use Slidev knowledge when:
